    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="service">
                ...
                if ($page_name == 'dashboard-admin.php') { ?>
                    ...
                    <?php } ?>
                    <img class="service-img" src="../assets/images/images-services/<?php echo $image ?>" alt="">
    ...
    document.querySelector("#services-section").addEventListener("click", function(event) {
        ...
        if (event.target.classList.contains("service-delete")) {
            ...
            if (confirm("Êtes-vous sûr de vouloir supprimer cet élément ?")) {
                ...
                xhr.open("GET", url + "/Garage-v-parrot/scripts/delete/delete-service.php?execute_script=true&id=" + id, true);
                xhr.send();
