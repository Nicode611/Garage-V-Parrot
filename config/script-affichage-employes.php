<?php //Affichage employés
    ...
    $sql = "SELECT id, role, prénom, nom, code_employé FROM users";
...
<script> // Script de sélection de la croix de supression (en AJAX)
    ...
    if (event.target.classList.contains("delete")) {
        ...
        if (confirm("Êtes-vous sûr de vouloir supprimer cet élément ?")) {
            ...
            xhr.open("GET", "/Garage-V-Parrot/config/script-affichage-employes.php?action=delete-employe&id=" + id, true);
            xhr.send();
